...
/*** PUT AN ICON DEPENDING IN GENRE ***/
...
/*** ASSIGN THE GENRE INPUT VALUE TO TEXT ***/
function assignID() {
...
function displayMatch(movie) {
  ...
  if (moviesList.length > 0) {
    ...
    if (lastMovie && lastMovie.poster_path) {
      ...
      console.log("The movie doesnt have poster");
    }
  } else {
    console.log("List of the movie is empty");
  }
}
...
/*** DISPLAY CERTAIN AMOUNT OF MOVIES - NEXT ***/
...
/*** DISPLAY CERTAIN AMOUNT OF MOVIES - PREVIOUS ***/

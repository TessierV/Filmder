...
async function getMovies() {
    ...
    try {
        ...
        displayMatch(resData.results[randomNumber]);
        displayMatchUI();
...
function showMovie2(movie) {
    ...
    <div style="display: flex; flex-direction: row; width: 100%; height: 100%;">
            ...
            <div style="flex-basis: 60%; display: flex; justify-content: center; align-items: center;">
                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; font-size:;">
...
function displayMatch(movie) {
    ...
    <center>
        ...
        <div class="NTMText">
            ...
            You and ${movie.title} have liked each other.
        </div>
    </center>
    `
}
